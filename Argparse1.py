...
if __name__ == "__main__":
    ...
    parser.add_argument("crust",type=str, choices=CRUSTS.keys(), help="Type of pizza crust")
    parser.add_argument("-t","--toppings",type=str,nargs="+",help="One or more toppings for your pizza")
    parser.add_argument("--extra-cheese",action="store_true",dest="cheese",help="Add extra cheese to your pizza")
    parser.add_argument("--extra-sauce",action="store_true",dest="sauce",help="Add extra sauce to your pizza")
